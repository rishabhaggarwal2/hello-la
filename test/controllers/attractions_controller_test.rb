...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { long_desc: @attraction.long_desc, short_desc: @attraction.short_desc, title: @attraction.title }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { long_desc: @attraction.long_desc, short_desc: @attraction.short_desc, title: @attraction.title }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
